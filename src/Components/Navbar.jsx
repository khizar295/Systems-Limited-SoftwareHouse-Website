        ...
        <nav className="nav d-flex justify-content-between align-items-center mx-5 px-5">
          <div className="d-flex align-items-center">
            ...
            <ul className="list-unstyled d-flex mb-1 ms-4">
              <li>
                <a href="" className="text-decoration-none m-2 p-3 text-light">
                  Services
                </a>
              </li>
              <li>
          ...
          <div className="d-flex align-items-center">
            ...
            <button className="border-0 bg-transparent border-start border-end border-2 border-light fs-2 pb-2">
              <a href="/" className="text-decoration-none mx-2 px-1 text-light">
                <CiSearch />
              </a>
            </button>
            <button className="border-0 bg-transparent fs-5 ms-2">
              <a href="/" className="text-decoration-none m-2 text-light">
                <CiGlobe />
                <FaArrowDown />
              </a>
            </button>
