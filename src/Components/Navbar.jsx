...
export default function Navbar() {
  return (
    <div className='fixed-top bg-transparent'>
        <div className='border-bottom border-2 border-dark container-fluid'>
      ...
      <div className="d-flex align-items-center">
        ...
        <button className='border-0 bg-transparent border-start border-end border-2 border-dark fs-2 pb-2'><a href="/" className='text-decoration-none mx-2 px-1 text-light'><CiSearch/></a></button>
